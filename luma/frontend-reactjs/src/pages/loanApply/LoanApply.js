         ...
         <button className="button"> <Link to="/dashboard">Dashboard</Link></button>   <button className="button"> <Link to="/view-loan">View Loan</Link></button>   <button className="button"> <Link to="/view-item-purchase">View item Purchase</Link></button>
          ...
          <h2>  Apply Loan</h2>
            ...
            <input
              ...
              onChange={handleInputChange}
            />
            <select style={{width:"100%",padding: "10px" }} name="item_category" className="sln"    onChange={handleInputChange} >
            ...
            <input
              ...
              onChange={handleInputChange}
            />
<select name="item_make" style={{width:"100%",padding: "10px" }}  className="loan-input-form"   onChange={handleInputChange} >
